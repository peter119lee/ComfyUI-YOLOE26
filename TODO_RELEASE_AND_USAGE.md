...
- 已正式對外發布
- 7 個節點均可正常運作
- helper / node-level 單元測試通過
- 已在真機 ComfyUI 環境完成 smoke 驗證（ComfyUI 0.18.1 · Python 3.12.7 · PyTorch 2.7.1+cu118 · ultralytics 8.3.207）
- README 與 example workflow 已對齊實際狀態
- provenance 已確認（prompt_segment.py 由 spawner1145 提供，已獲授權使用）
